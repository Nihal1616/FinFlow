...
export function StatCard({ label, value, color = "var(--text)" }) {
  return (
    ...
    >
      <div
        style={{ fontSize: "0.75rem", color: "var(--text3)", marginBottom: 4 }}
      >
        {label}
      </div>
      <div
...
export function TransactionItem({ tx, currentUserId }) {
  ...
  const iconBg =
    isAdd || !isSent ? "rgba(34,211,160,0.15)" : "rgba(255,87,87,0.15)";
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "right" }}>
        <div style={{ color, fontWeight: 700, fontFamily: "Syne, sans-serif" }}>
          {amount}
        </div>
